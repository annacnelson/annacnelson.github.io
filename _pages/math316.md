...
| 2. Aug. 24, 26, 28 | &nbsp;&nbsp;4. Linear equations: integrating factor (1.4.1) <br> &nbsp;&nbsp;5. Applications (1.3.2, 1.3.3, 1.4.2) <br> &nbsp;&nbsp;6. Autonomous Eqns: phase line, equilibria, stability (1.5.1) <br> | 1.3.2, 1.3.3, 1.4.1, 1.4.2, 1.4.3 | [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
| 3. Aug. 32, Sept. 2, 4 | <br> &nbsp;&nbsp;7. Population models <br> &nbsp;&nbsp;8. Existence and uniqueness, examples  <br> &nbsp;&nbsp; **Ch 2. Second order linear ODEs, homogeneous** <br> 9. Springs (unforced), damped, undamped (2.1) | 1.5.1, 1.5.3, 2.1| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
| 4. Sept. 7, 9, 11 |&nbsp;&nbsp; 10. *No class, Labor Day* <br> &nbsp;&nbsp;11. Review for exam  <br> &nbsp;&nbsp; 12. **Exam 1 (HW 1-3)** |[Review 1]()| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
| 5. Sept. 14, 16, 118 |  &nbsp;&nbsp; 13. Characteristic eq: real distinct roots (2.2.1) <br> &nbsp;&nbsp;14. Characteristic eq: repeated roots (2.2.2)  <br> &nbsp;&nbsp; 15. Characteristic eq: complex roots (2.2.) |2.2.1-2.2.4| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
| 6. Sept. 21, 23, 25 |  &nbsp;&nbsp; 15. Springs, unforced (2.2.4) <br> **Ch 2. Second order linear ODEs, nonhomogeneous** <br> &nbsp;&nbsp;16. Method of undetermined coefficients (2.3.1)  <br> &nbsp;&nbsp; 17. Method of undetermined coefficients (cont'd) |2.3.1, 2.3.2| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
| 7. Sept. 28, 30, Oct. 1 |  &nbsp;&nbsp; 18. Springs, forced, beats, and resonance (2.3.2) <br> &nbsp;&nbsp;19. Review <br> &nbsp;&nbsp; 20. **Exam 2 (HW 4-6)**  |[Review 2]()| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
| 8. Oct. 5, 7, 9 |  **Ch 3. Laplace Transforms** <br> &nbsp;&nbsp; 21. Definition, linearity, transforms of basic functions (3.1) <br>  <br> &nbsp;&nbsp;22.Solving IVPs using tables, partial fractions (3.2)  <br> &nbsp;&nbsp; 23. *No class, Fall break* |3.1, 3.2| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
| 9. Oct. 12, 14, 16 |  &nbsp;&nbsp; 24.The shift formula (3.2) <br>  <br> &nbsp;&nbsp;25.Step functions, piece-wise functions, Heaviside (3.2, 3.3)  <br> &nbsp;&nbsp; 26. Piece-wise forcing, convolution (3.3, 3.4) |3.2, 3.3., 3.4| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
...
| 13. Nov. 9, 11, 13 |  &nbsp;&nbsp; 36. Repeated eigenvalues: stars, degenerate (4.4.3)  <br> &nbsp;&nbsp;37. Real distinct eigenvalues: nodes, zero eigenvalue (4.4.1)   <br> &nbsp;&nbsp; 38. Complex eigenvalues: spirals, centers (4.4.2) |4.4.1, 4.4.2| [Instructions for all HW](/assets/teaching/math316/Math316_HW_instructions.pdf) <br> [HW 1, due Tues Aug 25]() for days 1,2|
